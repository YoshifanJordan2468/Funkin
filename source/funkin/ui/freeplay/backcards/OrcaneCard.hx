...
class OrcaneCard extends BackingCard
{
  ...
  {
    orangeBackShit.makeSolidColor(Std.int(pinkBack.width), 75, 0xFF0073e6);
    alsoOrangeLOL.makeSolidColor(100, Std.int(orangeBackShit.height), 0xFF0066cc);
    ...
    moreWays.funnyColor = 0xFFb3d9ff;
    moreWays.speed = 6.8;
    add(moreWays);

    funnyScroll.funnyColor = 0xFF1a8cff;
    ...
    funnyScroll2.funnyColor = 0xFF1a8cff;
    funnyScroll2.speed = -3.8;
    add(funnyScroll2);

    moreWays2.funnyColor = 0xFF1a8cff;
    moreWays2.speed = 6.8;
    add(moreWays2);

    funnyScroll3.funnyColor = 0xFF80bfff;
